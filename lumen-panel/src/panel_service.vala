...
// org.lumenshell.Panel1. Only the tray-host panel runs a service, so the verb
// always acts on the one real tray.
...
public class PanelService : GLib.Object {
    ...
    // True while the Control Center is open. Lets a caller branch without a
    // separate signal.
