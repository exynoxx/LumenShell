...
int main() {
    ...
    dk_ui_start_box(ctx, 0, 0);
        ...
        dk_ui_start_box(ctx, 0, 0);
            ...
            dk_ui_node *b1 = dk_ui_rect(ctx, 50, 50, (dk_color){1,1,1,0});
            dk_ui_node *b2 = dk_ui_rect(ctx, 50, 50, (dk_color){1,1,1,0});
            dk_ui_node *b3 = dk_ui_rect(ctx, 50, 50, (dk_color){1,1,1,0});
    ...
    while (display_dispatch_blocking() != -1) {
        ...
        if(b1->hovered){
            b1->data.color = (dk_color){1,1,1,0.2};
            dk_draw_node(ctx,b1);
        }
